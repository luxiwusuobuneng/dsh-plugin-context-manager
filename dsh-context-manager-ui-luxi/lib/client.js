// dsh-context-manager-ui-luxi — browser half.
//
// Delivered to the page through the dsh.client declaration in package.json:
// the host scan serves this file at /plugins/dsh-context-manager-ui-luxi/client.js
...
window.__ModuleLoader__.load({
  id: "dsh-context-manager-ui-luxi",
  factory: (require) => {
    var module = { exports: {} };
...
`;
    ...
    if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=\"" + cssTag + "\"]") === null) {
      ...
      tag.dataset.plugin = "dsh-context-manager-ui-luxi";
